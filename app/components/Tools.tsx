...
const tools = [
  ...
  },
  {
    ...
    description: 'Разработка легальных и безопасных схем оптимизации обязательных платежей. Полное соответствие законодательству, отсутствие признаков дробления бизнеса или необоснованной налоговой выгоды.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Глубокий, детальный анализ финансовой и налоговой документации за последние 3 года. Выявление "слепых" рисковых зон и пошаговый план устранения до предъявления претензий.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
