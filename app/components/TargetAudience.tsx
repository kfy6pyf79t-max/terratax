...
const audienceSegments = [
  {
    ...
    features: ['Аудит текущей налоговой нагрузки', 'Структурирование сделок и договоров', 'Допроверочная стадия подготовки', 'Защита при выездных и камеральных проверках'],
    icon: (
  ...
  },
  {
    ...
    subtitle: 'НПД, консультации',
    description: 'Консультирование при взаимодействии с контролирующими органами и контрагентами, защита прав налогоплательщиков.',
    features: ['Анализ рисков переквалификации договора с НПД в трудовые отношения', 'Экспертиза договоров с контрагентами', 'Решение спорных вопросов, в том числе по налоговым спорам'],
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function TargetAudience() {
  ...
  return (
    <section id="targetaudience" className="py-20 lg:py-32 bg-white">
